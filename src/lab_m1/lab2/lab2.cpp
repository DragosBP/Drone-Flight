...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices = 
        {
            ...
            VertexFormat(glm::vec3(0, 4,  0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(4, 0,  0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  4), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["tetrahedron_A"] = new Mesh("generated cube 1");
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices_square =
        {
            ...
            VertexFormat(glm::vec3(4, 0, 0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 4), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(4, 0, 4), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6))
        };
        ...
        meshes["square"] = new Mesh("generated cube 1");
...

    {
        vector<VertexFormat> vertices_bonus =
        {
            ...
            VertexFormat(glm::vec3(0, 4, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 4), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            ...
            VertexFormat(glm::vec3(4, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 4, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["tetrahedron_bonus"] = new Mesh("bonus");
        meshes["tetrahedron_bonus"]->InitFromData(vertices_bonus, indices_bonus);
    }
...
void Lab2::CreateMesh(const char *name, const std::vector<VertexFormat> &vertices, const std::vector<unsigned int> &indices)
{
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(vertices[0]) * vertices.size(), &vertices[0], GL_STATIC_DRAW);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron_A"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the mesh that was created with `CreateMesh()`
    RenderMesh(meshes["tetrahedron_B"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron_bonus"], shaders["VertexColor"], glm::vec3(3.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.0f, 0.0f, 0), glm::vec3(0.25f));
